export const SEMILLA_CIUDADZONA = [
  {
    ciudadzona: 'calacoto',
    valor: 0.2,
    ciudad_id: 1,
...
export const SEMILLA_ORIENTACION = [
  {
    orientacion: 'Norte',
    valor: 0.2,
  },
...
export const SEMILLA_TIPOPARED = [
  {
    tipopared: 'ladrillo',
    valor: 0.2,
  },
...
export const SEMILLA_TIPOSUELO = [
  {
...
export const SEMILLA_TIPOTECHO = [
  {
    tipotecho: 'calamina',
    valor: 0.2,
  },
...
export const SEMILLA_TIPOVIDRIO = [
  {
    tipovidrio: 'simple',
    valor: 0.2,
  },
...
export const SEMILLA_FACTORVIAJE = [
  {
    ciudad: 'El Alto',
    valor: 1.2,
  },
...
export const SEMILLA_GASTOPERSONA = [
  {
    nropersona: 1,
    alimento: 3,
    alojamiento: 1,
...
export const SEMILLA_INSTALTUBERIAS = [
  {
    inicio: 0,
    fin: 25,
    horas: 3,
